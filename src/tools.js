...
// 共享扫描 + 写入逻辑
export async function scanAndWrite(fs, sandboxPolicy, args, toolLabel) {
  ...
  const projectData = {
    ...
    description: (existing && existing.description && existing.description !== "Auto-generated by dsh-project-brain")
      ? existing.description
      : (scan.description || "Auto-generated by dsh-project-brain"),
