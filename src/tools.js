...
import { scanAndWrite, emitPreviewChanged } from "./host/scan-and-write.js";

// 共享扫描 + 写入逻辑（scanAndWrite + emitPreviewChanged + resolveWritePolicy）
// 已抽到 ./host/scan-and-write.js（v0.7.0-beta.3 release-fix）：
//   - 拆出目的是去掉 @deepseek-ai/dsh-tools 对 smoke / summarizer / sidebar 的传递依赖。
//   - 旧导出 `scanAndWrite` 在文件顶部已 import，保持调用方零改动。
